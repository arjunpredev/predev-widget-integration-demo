var SsdMobilenetv1Options = /** @class */ (function () {
    function SsdMobilenetv1Options(_a) {
        ...
        if (typeof this._minConfidence !== 'number' || this._minConfidence <= 0 || this._minConfidence >= 1) {
            throw new Error("".concat(this._name, " - expected minConfidence to be a number between 0 and 1"));
        }
        if (typeof this._maxResults !== 'number') {
            throw new Error("".concat(this._name, " - expected maxResults to be a number"));
        }
    }
