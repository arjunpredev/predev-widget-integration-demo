var MtcnnOptions = /** @class */ (function () {
    function MtcnnOptions(_a) {
        ...
        if (typeof this._minFaceSize !== 'number' || this._minFaceSize < 0) {
            throw new Error("".concat(this._name, " - expected minFaceSize to be a number > 0"));
        }
        if (typeof this._scaleFactor !== 'number' || this._scaleFactor <= 0 || this._scaleFactor >= 1) {
            throw new Error("".concat(this._name, " - expected scaleFactor to be a number between 0 and 1"));
        }
        if (typeof this._maxNumScales !== 'number' || this._maxNumScales < 0) {
            throw new Error("".concat(this._name, " - expected maxNumScales to be a number > 0"));
        }
        if (!Array.isArray(this._scoreThresholds)
            ...
            throw new Error("".concat(this._name, " - expected scoreThresholds to be an array of numbers of length 3"));
        }
        if (this._scaleSteps
            && (!Array.isArray(this._scaleSteps) || this._scaleSteps.some(function (th) { return typeof th !== 'number'; }))) {
            throw new Error("".concat(this._name, " - expected scaleSteps to be an array of numbers"));
        }
    }
