...
function extractorsFactory(weightMap, paramMappings) {
    ...
    function extractBatchNormParams(prefix) {
        var sub = extractWeightEntry("".concat(prefix, "/sub"), 1);
        var truediv = extractWeightEntry("".concat(prefix, "/truediv"), 1);
        return { sub: sub, truediv: truediv };
    }
    function extractConvParams(prefix) {
        var filters = extractWeightEntry("".concat(prefix, "/filters"), 4);
        var bias = extractWeightEntry("".concat(prefix, "/bias"), 1);
        return { filters: filters, bias: bias };
    }
    function extractConvWithBatchNormParams(prefix) {
        var conv = extractConvParams("".concat(prefix, "/conv"));
        var bn = extractBatchNormParams("".concat(prefix, "/bn"));
