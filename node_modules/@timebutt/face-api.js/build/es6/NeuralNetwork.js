    ...
    NeuralNetwork.prototype.dispose = function (throwOnRedispose) {
        ...
        this.getParamList().forEach(function (param) {
            if (throwOnRedispose && param.tensor.isDisposed) {
                throw new Error("param tensor has already been disposed for path ".concat(param.path));
            }
                ...
                switch (_a.label) {
                    case 0:
                        if (uri && typeof uri !== 'string') {
                            throw new Error("".concat(this._name, ".loadFromUri - expected model uri"));
                        }
                ...
                switch (_d.label) {
                    case 0:
                        if (filePath && typeof filePath !== 'string') {
                            throw new Error("".concat(this._name, ".loadFromDisk - expected model file path"));
                        }
    ...
    NeuralNetwork.prototype.traversePropertyPath = function (paramPath) {
        ...
        var result = paramPath.split('/').reduce(function (res, objProp) {
            if (!res.nextObj.hasOwnProperty(objProp)) {
                throw new Error("traversePropertyPath - object does not have property ".concat(objProp, ", for path ").concat(paramPath));
            }
            return { obj: res.nextObj, objProp: objProp, nextObj: res.nextObj[objProp] };
        }, { nextObj: this.params });
        var obj = result.obj, objProp = result.objProp;
        if (!obj || !objProp || !(obj[objProp] instanceof tf.Tensor)) {
            throw new Error("traversePropertyPath - parameter is not a tensor, for path ".concat(paramPath));
        }
