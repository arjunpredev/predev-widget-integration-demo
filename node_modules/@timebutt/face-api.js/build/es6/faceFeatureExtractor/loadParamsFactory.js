...
export function loadParamsFactory(weightMap, paramMappings) {
    ...
    function extractDenseBlock3Params(prefix, isFirstLayer) {
        ...
        var conv0 = isFirstLayer
            ? extractConvParams("".concat(prefix, "/conv0"))
            : extractSeparableConvParams("".concat(prefix, "/conv0"));
        var conv1 = extractSeparableConvParams("".concat(prefix, "/conv1"));
        var conv2 = extractSeparableConvParams("".concat(prefix, "/conv2"));
    ...
    function extractDenseBlock4Params(prefix, isFirstLayer) {
        ...
        var conv1 = extractSeparableConvParams("".concat(prefix, "/conv1"));
        var conv2 = extractSeparableConvParams("".concat(prefix, "/conv2"));
        var conv3 = extractSeparableConvParams("".concat(prefix, "/conv3"));
