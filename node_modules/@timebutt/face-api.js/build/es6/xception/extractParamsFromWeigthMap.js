...
function loadParamsFactory(weightMap, paramMappings) {
    ...
    function extractReductionBlockParams(mappedPrefix) {
        var separable_conv0 = extractSeparableConvParams("".concat(mappedPrefix, "/separable_conv0"));
        var separable_conv1 = extractSeparableConvParams("".concat(mappedPrefix, "/separable_conv1"));
        var expansion_conv = extractConvParams("".concat(mappedPrefix, "/expansion_conv"));
        return { separable_conv0: separable_conv0, separable_conv1: separable_conv1, expansion_conv: expansion_conv };
    }
    function extractMainBlockParams(mappedPrefix) {
        var separable_conv0 = extractSeparableConvParams("".concat(mappedPrefix, "/separable_conv0"));
        var separable_conv1 = extractSeparableConvParams("".concat(mappedPrefix, "/separable_conv1"));
        var separable_conv2 = extractSeparableConvParams("".concat(mappedPrefix, "/separable_conv2"));
...
export function extractParamsFromWeigthMap(weightMap, numMainBlocks) {
    ...
    range(numMainBlocks, 0, 1).forEach(function (idx) {
        middle_flow["main_block_".concat(idx)] = extractMainBlockParams("middle_flow/main_block_".concat(idx));
    });
