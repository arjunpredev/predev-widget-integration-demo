...
var TinyYolov2Options = /** @class */ (function () {
    function TinyYolov2Options(_a) {
        ...
        if (typeof this._inputSize !== 'number' || this._inputSize % 32 !== 0) {
            throw new Error("".concat(this._name, " - expected inputSize to be a number divisible by 32"));
        }
        if (typeof this._scoreThreshold !== 'number' || this._scoreThreshold <= 0 || this._scoreThreshold >= 1) {
            throw new Error("".concat(this._name, " - expected scoreThreshold to be a number between 0 and 1"));
        }
    }
