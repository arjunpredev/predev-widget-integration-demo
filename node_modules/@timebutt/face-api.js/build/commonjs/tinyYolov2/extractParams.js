...
function extractorsFactory(extractWeights, paramMappings) {
    ...
    function extractBatchNormParams(size, mappedPrefix) {
        ...
        paramMappings.push({ paramPath: "".concat(mappedPrefix, "/sub") }, { paramPath: "".concat(mappedPrefix, "/truediv") });
        return { sub: sub, truediv: truediv };
    }
    function extractConvWithBatchNormParams(channelsIn, channelsOut, mappedPrefix) {
        var conv = extractConvParams(channelsIn, channelsOut, 3, "".concat(mappedPrefix, "/conv"));
        var bn = extractBatchNormParams(channelsOut, "".concat(mappedPrefix, "/bn"));
