...
export function extractorsFactory(extractWeights, paramMappings) {
    ...
    function extractDenseBlock3Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
        ...
        var conv0 = isFirstLayer
            ? extractConvParams(channelsIn, channelsOut, 3, "".concat(mappedPrefix, "/conv0"))
            : extractSeparableConvParams(channelsIn, channelsOut, "".concat(mappedPrefix, "/conv0"));
        var conv1 = extractSeparableConvParams(channelsOut, channelsOut, "".concat(mappedPrefix, "/conv1"));
        var conv2 = extractSeparableConvParams(channelsOut, channelsOut, "".concat(mappedPrefix, "/conv2"));
    ...
    function extractDenseBlock4Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
        ...
        var conv3 = extractSeparableConvParams(channelsOut, channelsOut, "".concat(mappedPrefix, "/conv3"));
