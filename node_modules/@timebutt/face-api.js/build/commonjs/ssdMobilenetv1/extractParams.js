...
function extractorsFactory(extractWeights, paramMappings) {
    function extractDepthwiseConvParams(numChannels, mappedPrefix) {
        ...
        paramMappings.push({ paramPath: "".concat(mappedPrefix, "/filters") }, { paramPath: "".concat(mappedPrefix, "/batch_norm_scale") }, { paramPath: "".concat(mappedPrefix, "/batch_norm_offset") }, { paramPath: "".concat(mappedPrefix, "/batch_norm_mean") }, { paramPath: "".concat(mappedPrefix, "/batch_norm_variance") });
        return {
            filters: filters,
    ...
    function extractConvParams(channelsIn, channelsOut, filterSize, mappedPrefix, isPointwiseConv) {
        ...
        paramMappings.push({ paramPath: "".concat(mappedPrefix, "/filters") }, { paramPath: "".concat(mappedPrefix, "/").concat(isPointwiseConv ? 'batch_norm_offset' : 'bias') });
    ...
    function extractConvPairParams(channelsIn, channelsOut, mappedPrefix) {
        var depthwise_conv = extractDepthwiseConvParams(channelsIn, "".concat(mappedPrefix, "/depthwise_conv"));
        var pointwise_conv = extractPointwiseConvParams(channelsIn, channelsOut, 1, "".concat(mappedPrefix, "/pointwise_conv"));
