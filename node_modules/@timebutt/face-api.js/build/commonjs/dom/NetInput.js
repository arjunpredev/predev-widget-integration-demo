...
var NetInput = /** @class */ (function () {
    function NetInput(inputs, treatAsBatchInput) {
        ...
        if (!Array.isArray(inputs)) {
            throw new Error("NetInput.constructor - expected inputs to be an Array of TResolvedNetInput or to be instanceof tf.Tensor4D, instead have ".concat(inputs));
        }
        ...
        inputs.forEach(function (input, idx) {
            ...
            if (isTensor4D(input)) {
                ...
                if (batchSize !== 1) {
                    throw new Error("NetInput - tf.Tensor4D with batchSize ".concat(batchSize, " passed, but not supported in input array"));
                }
                _this._imageTensors[idx] = input;
    ...
    NetInput.prototype.toBatchTensor = function (inputSize, isCenterInputs) {
        ...
        return tf.tidy(function () {
            var inputTensors = range(_this.batchSize, 0, 1).map(function (batchIdx) {
                ...
                throw new Error("toBatchTensor - at batchIdx ".concat(batchIdx, ", expected input to be instanceof tf.Tensor or instanceof HTMLCanvasElement, instead have ").concat(input));
            });
