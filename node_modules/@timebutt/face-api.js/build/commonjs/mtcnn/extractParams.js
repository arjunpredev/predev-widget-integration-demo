...
function extractorsFactory(extractWeights, paramMappings) {
    ...
    function extractSharedParams(numFilters, mappedPrefix, isRnet) {
        ...
        var conv1 = extractConvParams(numFilters[0], numFilters[1], 3, "".concat(mappedPrefix, "/conv1"));
        var prelu1_alpha = extractPReluParams(numFilters[1], "".concat(mappedPrefix, "/prelu1_alpha"));
        var conv2 = extractConvParams(numFilters[1], numFilters[2], 3, "".concat(mappedPrefix, "/conv2"));
        var prelu2_alpha = extractPReluParams(numFilters[2], "".concat(mappedPrefix, "/prelu2_alpha"));
        var conv3 = extractConvParams(numFilters[2], numFilters[3], isRnet ? 2 : 3, "".concat(mappedPrefix, "/conv3"));
        var prelu3_alpha = extractPReluParams(numFilters[3], "".concat(mappedPrefix, "/prelu3_alpha"));
