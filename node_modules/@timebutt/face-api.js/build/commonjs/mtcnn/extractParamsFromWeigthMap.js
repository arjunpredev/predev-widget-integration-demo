...
function extractorsFactory(weightMap, paramMappings) {
    ...
    function extractConvParams(prefix) {
        var filters = extractWeightEntry("".concat(prefix, "/weights"), 4, "".concat(prefix, "/filters"));
        var bias = extractWeightEntry("".concat(prefix, "/bias"), 1);
        return { filters: filters, bias: bias };
    }
    function extractFCParams(prefix) {
        var weights = extractWeightEntry("".concat(prefix, "/weights"), 2);
        var bias = extractWeightEntry("".concat(prefix, "/bias"), 1);
    ...
    function extractSharedParams(prefix) {
        var conv1 = extractConvParams("".concat(prefix, "/conv1"));
        var prelu1_alpha = extractPReluParams("".concat(prefix, "/prelu1_alpha"));
        var conv2 = extractConvParams("".concat(prefix, "/conv2"));
        var prelu2_alpha = extractPReluParams("".concat(prefix, "/prelu2_alpha"));
        var conv3 = extractConvParams("".concat(prefix, "/conv3"));
        var prelu3_alpha = extractPReluParams("".concat(prefix, "/prelu3_alpha"));
